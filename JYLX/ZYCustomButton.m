...
//            
//            NSData *resultData = [NSData dataWithContentsOfURL:[NSURL URLWithString:URLstr]];
//            UIImage *img = [UIImage imageWithData:resultData];
//            
//            dispatch_sync(dispatch_get_main_queue(), ^{
//               //self.imageView.image = img;
//                if (img == nil) {
//                    [self setImage: _IMAGE(@"model_normal") forState:UIControlStateNormal];
//                 
//                }else{
...
//            [self setImageWithURL:[NSURL URLWithString:URLstr] forState:UIControlStateNormal placeholderImage:_IMAGE(@"model_normal") completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType) {
//                
//            }];
